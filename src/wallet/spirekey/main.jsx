...
function createHelloTransaction(message, spireKey) {
  return Pact.builder
    .execution((Pact.modules).free['hello-world'].here(message))
    .addSigner(
      {
...
function insertNewLineAtLength(str) {
  const screenWidth =
    window.innerWidth ||
