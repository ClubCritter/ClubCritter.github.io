    ...
    <div className="container-fluid footer">
      <footer className="row mx-auto tm-footer">
        <div className="col-md-6 tm-bg-dark p-3">
           Copyright 2024 Club Critter - <a href="https://x.com/KadenaCritter"> Cosmic Critter </a> Project - A <a href='https://kadpad.xyz/' target='_blank'>Kadpad</a> & <a href='https://www.tokengo.fun/' target='_blank'>Tokengo</a> Initiative - website developed by <a href='https://x.com/kabir_crypto' target='_blank'>ⓀKabir</a>
        </div>
